 ...
 * @e_ident: Ptr to Array with the ELF magic nos.
 ...
 * @e_ident: A ptr to Array of the ELF magic numbers.
 ...
 * @e_ident: Ptr to Array of the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
 ...
 * @e_ident: Ptr to an array of the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
 ...
 * @e_ident: Ptr to Array of the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
 ...
 * @e_ident: Ptr to Array of the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * main - Displays info in ELF Header at the beginning of File.
 * @argc: Nos of Args to a Program.
 * @argv: Array of ptrs to Args.
 * Return: 0 on Success.
 * Description: If file isn't ELF File or the fns fails - exit code 98
 */
